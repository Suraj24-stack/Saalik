  ...
  <section className="bg-black py-16 px-4">
    <div className="max-w-6xl mx-auto">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
        <span className="text-white">IN </span><span className="text-green-400">ASSOCIATION </span><span className="text-white">WITH</span>
      </h2>
      ...
      <div className="border-t border-green-500/20 pt-12 flex justify-center items-center space-x-6">
        <h3 className="text-2xl font-bold"><span className="text-green-400">SAALIK</span><span className="text-white"> GROUP:</span></h3>
