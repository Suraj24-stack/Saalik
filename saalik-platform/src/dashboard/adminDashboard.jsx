...
function SaalikAdminDashboard() {
  // Mock user data - replace with actual Redux in your app
  const [user] = useState({
    name: 'Admin User',
    email: 'admin@saalik.com',
    role: 'admin'
  });
  ...
  const allUsers = [
    ...
    { id: 2, name: 'Sarah Johnson', email: 'sarah@email.com', role: 'guide', status: 'active', joined: '2024-09-20', bookings: 45, spent: '$3,240' },
    { id: 3, name: 'Anita Gurung', email: 'anita@email.com', role: 'user', status: 'active', joined: '2024-10-10', bookings: 5, spent: '$425' },
    { id: 4, name: 'Michael Chen', email: 'michael@email.com', role: 'user', status: 'inactive', joined: '2024-08-05', bookings: 2, spent: '$170' },
    { id: 5, name: 'Pemba Sherpa', email: 'pemba@email.com', role: 'guide', status: 'active', joined: '2024-07-12', bookings: 127, spent: '$10,795' },
  ];
  ...
  const allBookings = [
    ...
    { id: 4, user: 'Michael Chen', guide: 'Karma Tamang', tour: 'Buddhist Monastery Circuit', date: '2025-10-18', time: '08:00 AM', status: 'completed', amount: '$110', duration: '6h' },
    { id: 5, user: 'Lisa Anderson', guide: 'Pemba Sherpa', tour: 'Ancient Newari Culture Tour', date: '2025-10-27', time: '11:00 AM', status: 'confirmed', amount: '$90', duration: '4h' },
  ];

  const allStories = [
    { id: 1, title: 'Tale of Kaal Bhairab', author: 'Admin', views: '12.5K', status: 'published', category: 'Mythology', date: '2025-10-10', likes: 856 },
    { id: 2, title: 'Kumari: Living Goddess', author: 'Admin', views: '8.3K', status: 'published', category: 'Tradition', date: '2025-10-08', likes: 623 },
    { id: 3, title: 'Newari Architecture', author: 'Admin', views: '6.7K', status: 'draft', category: 'Heritage', date: '2025-10-15', likes: 0 },
    { id: 4, title: 'Festivals of Nepal', author: 'Admin', views: '15.2K', status: 'published', category: 'Culture', date: '2025-10-05', likes: 1203 },
    { id: 5, title: 'Sacred Rivers and Ghats', author: 'Admin', views: '9.1K', status: 'published', category: 'Spirituality', date: '2025-10-12', likes: 742 },
    { id: 6, title: 'Traditional Craftsmanship', author: 'Admin', views: '0', status: 'draft', category: 'Arts', date: '2025-10-16', likes: 0 },
  ];

  const allGuides = [
    { id: 1, name: 'Pemba Sherpa', expertise: 'Mountain Heritage', rating: 4.9, bookings: 127, status: 'verified', joined: '2024-07-12', languages: ['English', 'Nepali', 'Sherpa'], phone: '+977-9841234567' },
    { id: 2, name: 'Mingma Dorje', expertise: 'Temple Tours', rating: 4.8, bookings: 98, status: 'verified', joined: '2024-08-20', languages: ['English', 'Nepali', 'Hindi'], phone: '+977-9841234568' },
    { id: 3, name: 'Tenzin Lama', expertise: 'Cultural Tours', rating: 4.7, bookings: 82, status: 'verified', joined: '2024-09-05', languages: ['English', 'Nepali', 'Tibetan'], phone: '+977-9841234569' },
    { id: 4, name: 'Karma Tamang', expertise: 'Historical Sites', rating: 4.8, bookings: 65, status: 'pending', joined: '2024-10-01', languages: ['English', 'Nepali', 'Tamang'], phone: '+977-9841234570' },
    { id: 5, name: 'Dorje Gurung', expertise: 'Adventure Tours', rating: 4.6, bookings: 43, status: 'pending', joined: '2024-10-10', languages: ['English', 'Nepali'], phone: '+977-9841234571' },
  ];

  const notifications = [
    { id: 1, type: 'booking', message: 'New booking from Rajesh Thapa', time: '5 min ago', read: false },
    { id: 2, type: 'guide', message: 'Guide application from Dorje Gurung', time: '1 hour ago', read: false },
    { id: 3, type: 'story', message: 'Story "Newari Architecture" pending review', time: '2 hours ago', read: true },
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {platformStats.map((stat, index) => (
                <div key={index} className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 p-6 hover:shadow-2xl hover:border-emerald-600 transition-all duration-300 group cursor-pointer">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className={`text-xs font-semibold flex items-center justify-end ${stat.trend === 'up' ? 'text-emerald-400' : 'text-red-400'}`}>
                  ...
                  <p className="text-xs text-emerald-400 mt-2">{stat.subtext}</p>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 p-6">
                ...
                <div className="h-64 flex items-end justify-around space-x-2">
                  {[65, 45, 80, 55, 70, 90, 75].map((height, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-emerald-500 to-teal-600 rounded-t-lg hover:from-emerald-400 hover:to-teal-500 transition-all cursor-pointer" style={{ height: `${height}%` }}></div>
                  ))}
                </div>
              ...
              {/* Popular Tours */}
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 p-6">
                <h3 className="text-xl font-semibold text-white mb-4">Popular Tours</h3>
                <div className="space-y-3">
                  {[
                    { name: 'Durbar Square Heritage Walk', bookings: 127, color: 'emerald' },
                    { name: 'Kaal Bhairab Temple Tour', bookings: 98, color: 'teal' },
                    { name: 'Kathmandu Valley Exploration', bookings: 82, color: 'cyan' },
                    { name: 'Buddhist Monastery Circuit', bookings: 65, color: 'blue' },
                  ].map((tour, i) => (
                    <div key={i}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm text-white">{tour.name}</span>
                        <span className="text-sm text-emerald-400 font-semibold">{tour.bookings}</span>
                      </div>
                      <div className="w-full bg-slate-700 rounded-full h-2">
                        <div className={`bg-gradient-to-r from-${tour.color}-500 to-${tour.color}-600 h-2 rounded-full transition-all duration-500`} style={{ width: `${(tour.bookings / 127) * 100}%` }}></div>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 overflow-hidden">
              <div className="p-6 border-b border-emerald-800 bg-gradient-to-r from-emerald-900/50 to-teal-900/50">
                ...
                <p className="text-slate-300 mt-1">Total Users: {allUsers.length}</p>
              </div>
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 p-6">
              ...
              <div className="space-y-4">
                {filteredBookings.map(booking => (
                  <div key={booking.id} className="p-5 bg-slate-700/50 rounded-xl border border-slate-600 hover:border-emerald-500 transition-all">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-1">{booking.tour}</h3>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-4">
                      <div>
                        ...
                        <p className="text-slate-300">📅 {new Date(booking.date).toLocaleDateString()}</p>
                      </div>
                      <div>
        ...
        {activeTab === 'stories' && (
          <div className="space-y-6">
            ...
            {/* Stories Grid */}
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 p-6">
              <h2 className="text-2xl font-bold text-white mb-6">Untold Stories Management</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredStories.map(story => (
                  <div key={story.id} className="p-5 bg-slate-700/50 rounded-xl border border-slate-600 hover:border-teal-500 transition-all group">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="text-lg font-semibold text-white group-hover:text-emerald-300 transition-colors">{story.title}</h3>
                      <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                        story.status === 'published' 
                          ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500'
                          : 'bg-slate-500/20 text-slate-300 border border-slate-500'
        ...
        {activeTab === 'guides' && (
          <div className="space-y-6">
            ...
            {/* Guides Grid */}
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-lg border border-emerald-800 p-6">
              <h2 className="text-2xl font-bold text-white mb-6">Guide Management</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredGuides.map(guide => (
                  <div key={guide.id} className="p-5 bg-slate-700/50 rounded-xl border border-slate-600 hover:border-emerald-500 transition-all">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <span className="text-sm text-yellow-400">⭐ {guide.rating}</span>
                        </div>
                      </div>
                      <span className={`px-3 py-1 text-xs font-medium rounded-full ${
                    ...
                    <div className="space-y-2 mb-4 text-sm text-slate-300">
                      ...
                      <p>📅 Joined {new Date(guide.joined).toLocaleDateString()}</p>
                      <div className="flex flex-wrap gap-2 mt-2">
                        {guide.languages.map((lang, i) => (
                          <span key={i} className="px-2 py-1 bg-cyan-500/20 text-cyan-300 rounded text-xs border border-cyan-500">
                            {lang}
                          </span>
                        ))}
                      </div>
